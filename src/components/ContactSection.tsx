        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="space-y-4">
              <a href="tel:+390000000000" className="flex items-center gap-3 text-foreground hover:text-secondary transition-colors">
              ...
              <a href="mailto:info@sunenergysrls.com" className="flex items-center gap-3 text-foreground hover:text-secondary transition-colors">
                <div className="w-10 h-10 bg-secondary/10 rounded-lg flex items-center justify-center">
                  <Mail className="w-5 h-5 text-secondary" />
                </div>
                <div>
                  <p className="text-sm font-medium">Email</p>
                  <p className="text-muted-foreground text-sm">info@sunenergysrls.com</p>
                </div>
              </a>
            ...
            <div className="rounded-xl overflow-hidden border border-border h-64">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6046438.16684!2d8.5!3d42.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12d4fe82448dd203%3A0x36bde958d48af820!2sItaly!5e0!3m2!1sen!2s!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
